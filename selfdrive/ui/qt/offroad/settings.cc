...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
    ...
    dispToggles->addItem(new CValueControl("ShowDebugUI", "DISP:调试信息", "", "../assets/offroad/icon_shell.png", 0, 2, 1));
    dispToggles->addItem(new CValueControl("ShowDateTime", "DISP:时间信息", "0:None,1:Time/Date,2:Time,3:Date", "../assets/offroad/icon_shell.png", 0, 3, 1));
    dispToggles->addItem(new CValueControl("ShowSteerRotate", "DISP:手柄旋转", "0:None,1:Rotate", "../assets/offroad/icon_shell.png", 0, 1, 1));
    dispToggles->addItem(new CValueControl("ShowPathEnd", "DISP:路径尽头", "0:None,1:Display", "../assets/offroad/icon_shell.png", 0, 2, 1));
    dispToggles->addItem(new CValueControl("ShowAccelRpm", "DISP:加速度计", "0:None,1:Display,1:Accel+RPM", "../assets/offroad/icon_shell.png", 0, 2, 1));
    dispToggles->addItem(new CValueControl("ShowTpms", "DISP:胎压监测系统", "0:None,1:Display", "../assets/offroad/icon_shell.png", 0, 1, 1));
    dispToggles->addItem(new CValueControl("ShowSteerMode", "DISP:手柄显示模式", "0:Black,1:Color,2:None", "../assets/offroad/icon_shell.png", 0, 2, 1));
    dispToggles->addItem(new CValueControl("ShowDeviceState", "DISP:设备状态", "0:None,1:Display", "../assets/offroad/icon_shell.png", 0, 1, 1));
    dispToggles->addItem(new CValueControl("ShowConnInfo", "DISP:APM连接", "0:NOne,1:Display", "../assets/offroad/icon_shell.png", 0, 1, 1));
    dispToggles->addItem(new CValueControl("ShowLaneInfo", "DISP:车道信息", "-1:None, 0:Path, 1:Path+Lane, 2: Path+Lane+RoadEdge", "../assets/offroad/icon_shell.png", -1, 2, 1));
    dispToggles->addItem(new CValueControl("ShowBlindSpot", "DISP:BSD 信息", "0:None,1:Display", "../assets/offroad/icon_shell.png", 0, 1, 1));
    dispToggles->addItem(new CValueControl("ShowGapInfo", "DISP:差距信息", "0:None,1:Display", "../assets/offroad/icon_shell.png", -1, 1, 1));
    dispToggles->addItem(new CValueControl("ShowDmInfo", "DISP:DM信息", "0:None,1:Display,-1:Disable(Reboot)", "../assets/offroad/icon_shell.png", -1, 1, 1));
    dispToggles->addItem(new CValueControl("ShowRadarInfo", "DISP:雷达信息", "0:None,1:Display,2:RelPos,3:Stopped Car", "../assets/offroad/icon_shell.png", 0, 3, 1));
    dispToggles->addItem(new CValueControl("ShowPlotMode", "DISP:调试图", "", "../assets/offroad/icon_shell.png", 0, 5, 1));


    pathToggles = new ListWidget(this);
    pathToggles->addItem(new CValueControl("ShowPathModeCruiseOff", "DISP: 路径模式：巡航关闭", "0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^", "../assets/offroad/icon_shell.png", 0, 15, 1));
    pathToggles->addItem(new CValueControl("ShowPathColorCruiseOff", "DISP: 路径颜色：巡航关闭", "(+10:Stroke)0:Red,1:Orange,2:Yellow,3:Green,4:Blue,5:Indigo,6:Violet,7:Brown,8:White,9:Black", "../assets/offroad/icon_shell.png", 0, 19, 1));
    pathToggles->addItem(new CValueControl("ShowPathMode", "DISP:路径模式：无车道", "0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^", "../assets/offroad/icon_shell.png", 0, 15, 1));
    pathToggles->addItem(new CValueControl("ShowPathColor", "DISP:路径颜色：无车道", "(+10:Stroke)0:Red,1:Orange,2:Yellow,3:Green,4:Blue,5:Indigo,6:Violet,7:Brown,8:White,9:Black", "../assets/offroad/icon_shell.png", 0, 19, 1));
    pathToggles->addItem(new CValueControl("ShowPathModeLane", "DISP:路径模式：车道模式", "0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^", "../assets/offroad/icon_shell.png", 0, 15, 1));
    pathToggles->addItem(new CValueControl("ShowPathColorLane", "DISP:路径颜色：车道模式", "(+10:Stroke)0:Red,1:Orange,2:Yellow,3:Green,4:Blue,5:Indigo,6:Violet,7:Brown,8:White,9:Black", "../assets/offroad/icon_shell.png", 0, 19, 1));
    pathToggles->addItem(new CValueControl("ShowPathWidth", "DISP:路径宽度比(100%)", "", "../assets/offroad/icon_shell.png", 10, 200, 10));

    startToggles = new ListWidget(this);
    startToggles->addItem(new CValueControl("SoundVolumeAdjust", "调节音量(100%)", "", "../assets/offroad/icon_shell.png", 5, 100, 5));
    startToggles->addItem(new CValueControl("SoundVolumeAdjustEngage", "调节音量、参与(10%)", "", "../assets/offroad/icon_shell.png", 5, 100, 5));
    startToggles->addItem(new CValueControl("MapboxStyle", "地图盒风格(0)", "", "../assets/offroad/icon_shell.png", 0, 2, 1));
    startToggles->addItem(new ParamControl("HotspotOnBoot", "启动时启用热点", "", "../assets/offroad/icon_shell.png", this));
    startToggles->addItem(new ParamControl("NoLogging", "禁用记录器r", "", "../assets/offroad/icon_shell.png", this));
